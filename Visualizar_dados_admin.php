    ...
    <div class="d-flex" id="wrapper">
        ...
        <div class="bg-white" id="sidebar-wrapper">
            ...
            <div class="list-group list-group-flush my-3">
                <a href="Painel_Administrador.php" class="list-group-item list-group-item-action bg-transparent second-text fw-bold"><i class="fas fa-id-card me-2"></i>Registrar Automobilista</a>
                <a href="Visualizar_dados_admin.php" class="list-group-item list-group-item-action bg-transparent second-text fw-bold color-2"><i class="fas fa-tachometer-alt me-2"></i>Visualizar Dados</a>
            </div>
        </div>
        <!-- /#sidebar-wrapper -->
                                        ...
                                        <table class="table">
                                            ...
                                            <tbody>
                                                ...
                                                curl_setopt_array($curl, array(
                                                    CURLOPT_URL => 'http://127.0.0.1:8000/api/getall-automobilista',
                                                ...
                                                foreach ((array) $response as $lista) { ?>
                                                    <tr>
                                                        <td><?= $lista->id ?></td>
                                                        <td><?= $lista->num_carta ?></td>
                                                        <td><?= $lista->nome ?></td>
                                                        <td><?= $lista->morada ?></td>
                                                        <td><?= $lista->categoria ?></td>
                                                        <td><?= $lista->fim_validade ?></td>
                                                        <td><a href="detalhes_automobilista.php?id=<?= $lista->id ?>">
                                                                <button type="button" class="btn btn-primary">Mais Dados</button>
                                                            </a></td>
